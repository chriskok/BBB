...
urlpatterns = [
    ...
    path('rubric_creation_2/<int:q_id>', views.rubric_creation_2, name='rubric_creation_2'),
    path('generate_new_suggestions/<int:q_id>/<str:button_pressed>', views.generate_new_suggestions, name='generate_new_suggestions'),
    ...
    path('rubric_refinement/<int:q_id>/<str:additional>', views.rubric_refinement, name='rubric_refinement'),
    path('rubric_refinement_2/<int:q_id>', views.rubric_refinement_2, name='rubric_refinement_2'),
